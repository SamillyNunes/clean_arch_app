...
void main() {
  ...
  group(
    ...
    () {
      ...
      test(
        'Should return null if post returns 204a',
        () async {
      ...
      test(
        'Should return null if post returns 204 with data (it shouldnt)',
        () async {
          mockResponse(204);
      ...
      test(
        'Should return BadRequestError if post returns 400 with body',
        () async {
